...
class VersionUtility
{
     ...
     * @return number
     */
    public static function convertVersionId($version)
    {
        $version_arr = explode('.', $version);
    
        $major_version = $version_arr[0];
        $minor_version = $version_arr[1];
        $release_version = $version_arr[2];
    ...
    {
        return RC_Config::get('release.version');
    }
     ...
     * 获得需要升级的版本号列表。
     *
     * @param string $version1  旧版本号
     * @param string $version2  新版本号
     *
     * @return array
     */
    public static function getUpgradeVersionList($version1, $version2)
    {
